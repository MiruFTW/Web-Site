...
if (!isset($_GET['page'])) // page does not exist on initial load
{
	...
	echo '<li><a href="../hw15/index.php?page=school">School</a></li>';
	echo '<li><a href="../hw15/index.php?page=hobbies">Hobbies</a></li>';
	echo '<li><a href="../hw15/index.php?page=movies">Movies</a></li>';
...
else // page vairable does exist use switch to for different pages
{
	switch($_GET['page'])
	{
		...
		case "school":
			echo '<li><a href="../hw15/index.php">Home</a></li>';
			echo '<li><a href="../hw15/index.php?page=work">Work</a></li>';
			echo '<li class="active"><a href="../hw15/index.php?page=school">School</a></li>';
			echo '<li><a href="../hw15/index.php?page=hobbies">Hobbies</a></li>';
			echo '<li><a href="../hw15/index.php?page=movies">Movies</a></li>';
			echo '<li><a href="../hw15/index.php?page=contact">Contact</a></li>';
			break;
		case "hobbies":
			...
			echo '<li><a href="../hw15/index.php?page=work">Work</a></li>';
			echo '<li><a href="../hw15/index.php?page=school">School</a></li>';
			echo '<li class="active"><a href="../hw15/index.php?page=hobbies">Hobbies</a></li>';
			echo '<li><a href="../hw15/index.php?page=movies">Movies</a></li>';
			echo '<li><a href="../hw15/index.php?page=contact">Contact</a></li>';
			break;
		case "movies":
			...
			echo '<li><a href="../hw15/index.php?page=school">School</a></li>';
			echo '<li><a href="../hw15/index.php?page=hobbies">Hobbies</a></li>';
			echo '<li class="active"><a href="../hw15/index.php?page=movies">Movies</a></li>';
			echo '<li><a href="../hw15/index.php?page=contact">Contact</a></li>';
			break;
		case "contact":
			echo '<li><a href="../hw15/index.php">Home</a></li>';
