...
<html lang="en">
  <head>
    ...
    <link rel="icon" href="file:///C|/Users/alfon/Documents/favicon.ico">
	 <link rel="stylesheet" href="../hw19/assets/css/main.css">

    <title>Welcome to Alfonso's Homepage!</title>

    <!-- Bootstrap core CSS -->
    <link href="../hw19/assets/css/bootstrap.min.css" rel="stylesheet">

    <!-- Custom styles for this template -->
    <link href="../hw19/assets/css/justified-nav.css" rel="stylesheet">

    <!-- Just for debugging purposes. Don't actually copy these 2 lines! -->
    <!--[if lt IE 9]><script src="../../assets/js/ie8-responsive-file-warning.js"></script><![endif]-->
    <script src="../hw19/assets/js/ie-emulation-modes-warning.js"></script>
